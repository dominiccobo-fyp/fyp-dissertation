...
\begin{figure}[h!]
	\digraph[width=\textwidth]{workItemsImpactMap}{rankdir=LR; 
		...
		developer->contribute_work_items_associated_with_changes_to_api;
		
		awareness_of_consumer_related_work->pull_query_of_work_items_for_developer;
		contribute_work_items_associated_with_changes->issues_raised_on_github;
		contribute_work_items_associated_with_changes->issues_raised_on_gitlab;
		...
		contribute_work_items_associated_with_usages_of_api->issues_raised_on_github;
		contribute_work_items_associated_with_usages_of_api->issues_raised_on_gitlab;
	...
	\caption{Impact Mapping a route to increased awareness of associated dwork items}
\end{figure}
